...
class ObjectNode extends React.Component {
  ...
  render() {
    ...
    let ellipsesSpan = !empty && !expanded && /*#__PURE__*/React.createElement("span", null, "...");

    // leading wrapper
    let preSpan = /*#__PURE__*/React.createElement("span", null, type < OBJECT ? '[' : '{');

    // trailing wrapper and comma
    let postSpan = /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("span", null, type < OBJECT ? ']' : '}'), !isLast && ',');

    // label with trailing colon space 
    let label = objKey != null && /*#__PURE__*/React.createElement(React.Fragment, null, objKey, /*#__PURE__*/React.createElement("span", null, ":\xA0"));
    return /*#__PURE__*/React.createElement("div", {
      className: className
    }, /*#__PURE__*/React.createElement("div", {
      className: "objectexhibitor-node-key objectexhibitor-node-key-toggle",
      onClick: this.handleToggle
    }, /*#__PURE__*/React.createElement("span", null, expanded ? '⏷' : '⏵'), label, preSpan, ellipsesSpan, !expanded && postSpan), /*#__PURE__*/React.createElement("div", {
...
const PrimitiveNode = ({
  ...
  let commaSpan = !isLast && /*#__PURE__*/React.createElement("span", null, ",");
  return /*#__PURE__*/React.createElement("div", {
