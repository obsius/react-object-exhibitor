...
// entry point
class ObjectExhibitor extends React.Component {
  render() {
    let {
      obj,
      collapsed = false,
...
class ObjectNode extends React.Component {
  ...
  render() {
    ...
    let expander = i > 0 && /*#__PURE__*/React.createElement("span", null, expanded ? '⏷' : '⏵');

    // label with trailing colon space or no label in skeleton mode reference
    let label = objKey != null ? /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("span", null, objKey), /*#__PURE__*/React.createElement("span", null, ":\xA0")) : expanded && skeleton && /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("span", null, type < OBJECT ? '[]' : '{}'), /*#__PURE__*/React.createElement("span", null, ":\xA0"));

    // leading wrapper
    let preSpan = (!expanded || !skeleton) && /*#__PURE__*/React.createElement("span", null, type < OBJECT ? '[' : '{');

    // ellipses for collapsed non-empty objects
    let ellipsesSpan = i > 0 && !expanded && /*#__PURE__*/React.createElement("span", null, "...");

    // trailing wrapper and comma
    let postSpan = (!expanded || !skeleton) && /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("span", null, type < OBJECT ? ']' : '}'), /*#__PURE__*/React.createElement("span", null, !last && !skeleton && ','));
    if (hideRoot) {
      ...
      }, expander, label, preSpan, ellipsesSpan, !expanded && postSpan), /*#__PURE__*/React.createElement("div", {
        className: valueClassName
      }, children), expanded && postSpan);
    }
  }
}
...
const PrimitiveNode = ({
  ...
  let keyDiv = objKey != null && /*#__PURE__*/React.createElement("div", {
    className: "objectexhibitor-node-key"
  }, /*#__PURE__*/React.createElement("span", null, objKey), /*#__PURE__*/React.createElement("span", null, ":\xA0"));

  // trailing comma (not shown for the last object of a list)
  let commaSpan = !last && /*#__PURE__*/React.createElement("span", null, ",");
  return /*#__PURE__*/React.createElement("div", {
    className: "objectexhibitor-node"
  }, keyDiv, /*#__PURE__*/React.createElement("div", {
    className: valueClassName
  }, /*#__PURE__*/React.createElement("span", null, value), commaSpan));
};
